...
export interface ThemeConfiguration {
    ...
    ListResponse: AxiosPromise<paths['/themes/{uuid}/configurations']['get']['responses']['200']['content']['application/json']>;
    CreateResponse: AxiosPromise<paths['/themes/{uuid}/configurations/validate']['post']['responses']['200']['content']['application/json']>;
}
export interface ThemeCustomTemplate {
    GetResponse: AxiosPromise<operations['get-themes-theme_uuid-custom-templates']['responses']['200']['content']['application/json']>;
}
