...
export interface CustomerAttribute {
    ...
    CreateResponse: AxiosPromise<operations['CustomersAttributesPost']['responses']['200']['content']['application/json']>;
...
export interface CustomerAttributeValue {
    ...
    ListResponse: AxiosPromise<operations['CustomersAttributeValuesGet']['responses']['200']['content']['application/json']>;
    UpdateRequest: operations['CustomersAttributeValuesPut']['requestBody']['content']['application/json'];
    UpdateResponse: AxiosPromise<operations['CustomersAttributeValuesPut']['responses']['200']['content']['application/json']>;
...
export interface CustomerFormFieldValue {
    ...
    UpdateResponse: AxiosPromise<operations['CustomerFormFieldValuePUT']['responses']['200']['content']['application/json']>;
}
export interface CustomerConsent {
    GetResponse: AxiosPromise<operations['CustomersConsentByCustomerId_PUT']['responses']['200']['content']['application/json']>;
    UpdateRequest: operations['CustomersConsentByCustomerId_PUT']['requestBody']['content']['application/json'];
    UpdateResponse: AxiosPromise<operations['CustomersConsentByCustomerId_PUT']['responses']['200']['content']['application/json']>;
}
