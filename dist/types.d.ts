...
export declare type AxiosPromise<T> = Promise<AxiosResponse<T>>;
interface FormField {
    name: string;
    value: string;
}
...
declare type OrderProductsUpdate = Partial<Omit<OrderProduct, 'sku'>> & {
    id?: number;
    product_id?: number;
...
export declare type V2OrderUpdateRequest = Partial<Omit<V2OrderRequestBase, 'products' | 'billing_address'>> & {
...
export declare type V2OrderShipmentsUpdateRequest = Partial<Omit<V2OrderShipmentsRequestBodyBase, 'items'>>;
