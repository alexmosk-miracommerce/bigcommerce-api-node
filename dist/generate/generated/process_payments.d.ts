        ...
        requestBody: {
            content: {
                'application/json': {
                    /** Payment */
                    payment: {
                        instrument: Partial<components['schemas']['Card']> & Partial<components['schemas']['StoredCard']> & Partial<components['schemas']['StoredPayPalAccount']> & Partial<components['schemas']['GiftCertificate']> & Partial<components['schemas']['StoreCredit']> & Partial<components['schemas']['TokenizedCard']>;
