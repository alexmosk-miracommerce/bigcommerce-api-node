...
export interface components {
    schemas: {
        ...
        PagesCollectionResponse: {
            data?: (Partial<components['schemas']['typePage']> & Partial<components['schemas']['typeBlog']> & Partial<components['schemas']['typeContactForm']> & Partial<components['schemas']['typeFeed']> & Partial<components['schemas']['typeRaw']> & Partial<components['schemas']['typeLink']>)[];
    ...
    headers: {
        ...
        Accept?: string;
        /** Your API account's access token. */
        'X-Auth-Token'?: string;
    };
}
