...
export interface operations {
    ...
    postConsent: {
        ...
        /** Data sent to the [Update customer consent](/docs/rest-management/customers/customer-consent#update-customer-consent) endpoint when creating a customer during checkout. */
        requestBody: {
            content: {
